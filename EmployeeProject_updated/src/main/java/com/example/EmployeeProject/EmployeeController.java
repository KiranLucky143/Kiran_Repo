...
public class EmployeeController {
	...
	@GetMapping("/getEmpsStartingWith/{empName}")
	public List<Employee> findAllEmployeesStartingWith(@PathVariable("empName") String empName) {
		
		
		return employeeService.findByEmployeesStartingWith(empName);
	}
	
	
	@GetMapping("/findDataByBandAndExperience/{band}/{experience}")
	public List<Employee> findDataByBandAndExperience(@PathVariable("band") String band,@PathVariable("experience") Integer experience) {
		
		
		return employeeService.findDataByBandAndExperience(band, experience);
	}
